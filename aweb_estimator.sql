...
--
-- Host: localhost:3306
-- Generation Time: Apr 14, 2017 at 03:31 AM
...
(5, 'server', 'Yes, It is a <b>Linux Hosting</b>', '', 'linux', 1, 0, 0, 'radio', NULL, 0, 2),
(6, 'server', 'Yes, It is a <b>Windows Hosting</b>', '', 'windows', 1, 0, 30, 'radio', NULL, 0, 2),
(7, 'server', 'Other or not sure', '', 'other', 1, 0, 40, 'radio', NULL, 0, 2),
(8, 'server', 'No, we will buy a new hosting', '', 'no', 1, 0, 30, 'radio', NULL, 0, 2),
(9, 'home', 'Home Page', '', 'static_pages', 1, 1, 360, 'checkbox', NULL, 0, 3),
(10, 'about', 'About Us Page', '', 'static_pages', 0, 0, 60, 'checkbox', NULL, 0, 3),
(11, 'privacy', 'Privacy Policy Page', '', 'static_pages', 0, 0, 40, 'checkbox', NULL, 0, 3),
(12, 'terms', 'Terms and Conditions Page', '', 'static_pages', 0, 0, 40, 'checkbox', NULL, 0, 3),
(13, 'contact', 'Contact Us Page', '', 'static_pages', 0, 0, 60, 'checkbox', NULL, 0, 3),
(14, 'more_static', 'and', 'more custom static page(s)', '0', 0, 0, 60, 'number', NULL, 0, 3),
...
(17, 'ecommerce_products', '', 'products(s)', '1', 1, 0, 20, 'number', NULL, 0, 5),
...
(23, 'paypal', 'Via PayPal (No requirements)', '', 'ecommerce_payment', 0, 0, 30, 'checkbox', NULL, 0, 8),
(24, 'card', 'Credit Card Direct Payment (Needs some merchandise information)', '', 'ecommerce_payment', 0, 0, 360, 'checkbox', NULL, 0, 8),
(25, 'other', 'Others (Wire, Pay on Delivery, etc. )', '', 'ecommerce_payment', 0, 0, 360, 'checkbox', NULL, 0, 8),
(26, 'ecommerce_ssl', 'Yes, I do.', '', 'yes', 1, 0, 15, 'radio', NULL, 0, 9),
(27, 'ecommerce_ssl', 'No, I don\'t want it.', '', 'no', 1, 0, 0, 'radio', NULL, 0, 9),
(28, 'logo', 'Logo Design', 'Description', 'additional', 0, 0, 500, 'checkbox', NULL, 0, 10),
(29, 'underconstruction', 'Custom Under Construction Page', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(30, 'content', 'Content Writing Service', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(31, 'social', 'Social Media Management', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(32, 'speed', 'Speed Optimization', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(33, 'seo', 'Organic Search Engine Optimization', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(34, 'ads', 'Marketing & Advertisement', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(35, 'backup', 'Auto/Cloud Backup', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(36, 'security', 'Extra Security', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(37, 'newsletter', 'Newsletter', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(38, 'chat', 'Live Support Chat Feature', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(39, 'maintenance', 'Periodic Maintenance & Updates', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10),
(40, 'custom', 'Custom Requests & Programs', 'Description', 'additional', 0, 0, 360, 'checkbox', NULL, 0, 10);
